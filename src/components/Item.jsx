...
import { state, damp } from '@/Utils/threeUtils'
...
export default function Item ({ index, position, scale, c = new THREE.Color(), ...props }) {
  ...
  return <Image ref={ref} {...props} position={position} scale={scale} onClick={click} onPointerOver={over} onPointerOut={out} alt='Imagen de actividad realizada en el tirol 3' />
}