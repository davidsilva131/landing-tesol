...
const Overlay = () => {
  return (
    <div className='absolute top-0 left-0 pointer-events-none w-full h-full'>
      ...
      <Link className='absolute top-9 right-10 pointer-events-auto' href='https://www.instagram.com/solidariotesol/' target='_blank' alt='Link al instagram de tejido solidario'>
